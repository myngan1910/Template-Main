...
const requireName = require('../../middleware/admin/service.js')
...
router.post('/createser',upload.single('icon'),requireName.checkName, serviceController.postCreateService)
